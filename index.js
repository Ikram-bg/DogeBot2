...
console.log(color('> WA NUMBER: +918080392095 ','silver'))
...
dogexeon.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
   ...
   // owner
    ...
    const htod = "918080392095@s.whatsapp.net"
...
dogexeon.on('group-update', async (anu) => {
    ...
    dogexeon.on('chat-update', async (message) => {
        ...
        ownerNumber = ["918080392095@s.whatsapp.net","918080392095@s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]
        dtod = "918080392095@s.whatsapp.net"
