...
console.log(color('> WA NUMBER: ++1 (669) 271-7791 ','silver'))
...
dogexeon.on('group-update', async (anu) => {
    ...
    dogexeon.on('chat-update', async (message) => {
        ...
        ownerNumber = ["+1 (669) 271-7791@s.whatsapp.net","+1 (669) 271-7791@s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]
        dtod = "+1 (669) 271-7791@s.whatsapp.net"
